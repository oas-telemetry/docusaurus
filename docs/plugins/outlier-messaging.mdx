---
sidebar_position: 10
sidebar_label: Outlier Messaging Example
---

# Outlier Messaging Plugin

OAS Telemetry provides an example Outlier Messaging Plugin that demonstrates how to alert for anomalies (abnormal response times) through messaging platforms. In this case, a Telegram Channel.

The full example is available in the [repository](https://github.com/oas-tools/oas-telemetry-plugin-outlier-messaging).
